...
export const Contact = () => {
  ...
  return (
    <section id="contacto" className="py-20 sm:py-28 px-5 sm:px-8" style={{ background: '#0a0b14' }}>
      <div className="max-w-4xl mx-auto">
        ...
        <motion.div
          ...
          style={{
            background: 'linear-gradient(135deg, #111220 0%, #1a1030 100%)',
            borderColor: 'rgba(168,85,247,0.25)',
            boxShadow: '0 0 80px rgba(168,85,247,0.08)',
          }}
        >
          {/* Glow orbs */}
          <div className="absolute top-0 right-0 w-80 h-80 rounded-full pointer-events-none opacity-20 blur-3xl"
            style={{ background: 'radial-gradient(circle, #a855f7, transparent 70%)' }} />
          <div className="absolute bottom-0 left-0 w-64 h-64 rounded-full pointer-events-none opacity-15 blur-3xl"
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold leading-tight tracking-tight mb-5 text-white">
            ...
            <a
              ...
              className="inline-flex items-center gap-3 font-bold text-base px-8 py-4 rounded-2xl transition-all active:scale-95 mb-8 text-white"
              style={{
