    ...
    <section id="contacto" className="py-20 sm:py-28 px-5 sm:px-8" style={{ background: '#0a0b14' }}>
      <div className="max-w-4xl mx-auto">
        ...
        <motion.div
          ...
          style={{
            background: 'linear-gradient(135deg, #111220 0%, #18100a 100%)',
            borderColor: 'rgba(249,115,22,0.22)',
            boxShadow: '0 0 80px rgba(249,115,22,0.07)',
          }}
        >
          {/* Glow orbs */}
          <div className="absolute top-0 right-0 w-80 h-80 rounded-full pointer-events-none opacity-18 blur-3xl"
            style={{ background: 'radial-gradient(circle, #f97316, transparent 70%)' }} />
          <div className="absolute bottom-0 left-0 w-64 h-64 rounded-full pointer-events-none opacity-12 blur-3xl"
