...
export const Navbar = ({ scrollTo, activeSection }: NavbarProps) => {
          ...
          >
            ...
            >
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 text-white/40 hover:text-white/65 text-sm transition-colors py-2"
              >
                <Mail size={15} />
